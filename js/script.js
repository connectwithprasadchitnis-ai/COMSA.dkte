document.addEventListener('DOMContentLoaded', () => {
    ...
    // Render team grid using TEAM_MEMBERS from team-data.js
    let delay = 100;
    TEAM_MEMBERS.forEach(member => {
        const cardHTML = `
            <div class="team-card cursor-pointer group reveal-up active" data-member="${member.id}" style="transition-delay: ${delay}ms;">
    ...
    const openModal = (id) => {
        ...
        modalEmail.href = member.email ? `mailto:${member.email}` : "#";
